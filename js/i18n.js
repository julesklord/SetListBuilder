...
en:{
  ...
  // nav
  nav_builder:'Builder', nav_shows:'Shows', nav_pool:'Pool', nav_export:'Export', nav_docs:'Docs',
  // sidebar
  instruments:'Band instruments tonight',
  instr_hint:'Generation prioritizes songs matching your active instruments. Songs are scored by energy curve and effort balance across sets.',
  ...
  btn_export_json:'Export JSON', import_export_hint:'Import your song list via CSV template or JSON backup. Export to back up or share your pool between devices.', btn_import_json:'Import JSON', btn_export_bld:'Export',
  quick_start:'Quick start guide',
  qs_1:'Select the band instruments available tonight',
  qs_2:'Choose # of sets & duration — set effort weights in sidebar',
  qs_3:'Pick genres to include — 24 genres available',
  qs_4:'Click Generate Setlist — energy curve + effort balance',
  qs_5:'Drag rows to reorder songs within a set',
  qs_6:'Go to Pool to manage songs — add via form or import CSV',
  qs_7:'Export as PDF, HTML, JSON, or text — save shows in Shows tab',
  qs_note:'All data stays in your browser. No account needed.',
  generate:'Generate Setlist',
  // instruments
  guitar:'Guitar',
  instr_eg:'El. Guitar', instr_ag:'Ac. Guitar', instr_b:'Bass', instr_dr:'Drums', instr_k:'Keys', instr_sx:'Sax', instr_tp:'Trumpet', instr_tb:'Trombone', instr_vo:'Lead Vox', instr_bv:'BV', instr_pc:'Perc', piano:'Piano', winds:'Winds', voice:'Voice',
  // api bar
...
es:{
  ...
  nav_builder:'Constructor', nav_shows:'Conciertos', nav_pool:'Cancionero', nav_export:'Exportar', nav_docs:'Docs',
  instruments:'Instrumentos de la banda esta noche',
  instr_hint:'La generación prioriza canciones que coincidan con tus instrumentos activos. Las canciones se distribuyen por curva de energía y balance de esfuerzo entre sets.',
  ...
  btn_export_json:'Exportar JSON', import_export_hint:'Importa tu lista de canciones via plantilla CSV o respaldo JSON. Exporta para compartir el pool entre dispositivos.', btn_import_json:'Importar JSON', btn_export_bld:'Exportar',
  quick_start:'Guía rápida',
  qs_1:'Selecciona los instrumentos de la banda disponibles esta noche',
  qs_2:'Elige nº de sets y duración — ajusta ponderaciones de esfuerzo',
  qs_3:'Selecciona géneros a incluir — 24 géneros disponibles',
  qs_4:'Clic en Generar Setlist — curva de energía + balance de esfuerzo',
  qs_5:'Arrastra filas para reordenar canciones dentro de un set',
  qs_6:'Ve al Pool para gestionar canciones — agrega por formulario o importa CSV',
  qs_7:'Exporta como PDF, HTML, JSON o texto — guarda shows en la pestaña Shows',
  qs_note:'Todos los datos se quedan en tu navegador. Sin cuenta.',
  generate:'Generar Setlist',
  guitar:'Guitarra',
  instr_eg:'Guitarra El.', instr_ag:'Guitarra Ac.', instr_b:'Bajo', instr_dr:'Batería', instr_k:'Teclado', instr_sx:'Saxofón', instr_tp:'Trompeta', instr_tb:'Trombón', instr_vo:'Voz Principal', instr_bv:'Coros', instr_pc:'Percusión', piano:'Piano', winds:'Vientos', voice:'Voz',
...
pt:{
  ...
  nav_builder:'Construtor', nav_shows:'Shows', nav_pool:'Cancioneiro', nav_export:'Exportar', nav_docs:'Docs',
  instruments:'Instrumentos da banda esta noite',
  instr_hint:'A geração prioriza músicas que correspondam aos seus instrumentos ativos. As músicas são distribuídas por curva de energia e equilíbrio de esforço entre sets.',
  ...
  qs_1:'Selecione os instrumentos da banda disponíveis esta noite',
  qs_2:'Escolha nº de sets e duração — ajuste os pesos de esforço',
  qs_3:'Selecione gêneros a incluir — 24 gêneros disponíveis',
  qs_4:'Clique em Gerar Setlist — curva de energia + equilíbrio de esforço',
  qs_5:'Arraste linhas para reordenar músicas dentro de um set',
  qs_6:'Vá ao Pool para gerenciar músicas — adicione pelo formulário ou importe CSV',
  qs_7:'Exporte como PDF, HTML, JSON ou texto — salve shows na aba Shows',
  qs_note:'Todos os dados ficam no seu navegador. Sem conta.',
  generate:'Gerar Setlist',
  guitar:'Guitarra',
  instr_eg:'Guitarra El.', instr_ag:'Guitarra Ac.', instr_b:'Baixo', instr_dr:'Bateria', instr_k:'Teclado', instr_sx:'Saxofone', instr_tp:'Trompete', instr_tb:'Trombone', instr_vo:'Voz Principal', instr_bv:'Backing Vox', instr_pc:'Percussão', piano:'Piano', winds:'Metais/Sopros', voice:'Voz',
...
ru:{
  ...
  nav_builder:'Конструктор', nav_shows:'Концерты', nav_pool:'Каталог', nav_export:'Экспорт', nav_docs:'Помощь',
  instruments:'Инструменты группы сегодня',
  instr_hint:'Генерация отдаёт приоритет песням для выбранных инструментов. Распределение строится по кривой энергии и балансу усилий между сетами.',
  ...
  btn_export_json:'Экспорт JSON', import_export_hint:'Импортируйте список через шаблон CSV или JSON. Экспортируйте для резервной копии или синхронизации.', btn_import_json:'Импорт JSON', btn_export_bld:'Экспорт',
  quick_start:'Быстрый старт',
  qs_1:'Выберите инструменты группы на сегодня',
  qs_2:'Выберите количество сетов и длительность — настройте веса усилий',
  qs_3:'Выберите жанры — доступно 24 жанра',
  qs_4:'Нажмите Создать сетлист — кривая энергии + баланс усилий',
  qs_5:'Перетаскивайте строки для изменения порядка в сете',
  qs_6:'Перейдите в Pool для управления — добавьте через форму или импорт CSV',
  qs_7:'Экспорт как PDF, HTML, JSON или текст — сохраняйте шоу на вкладке Shows',
  qs_note:'Все данные хранятся в браузере. Аккаунт не нужен.',
  generate:'Создать сетлист',
  guitar:'Гитара',
  instr_eg:'Эл. гитара', instr_ag:'Акуст. гитара', instr_b:'Бас', instr_dr:'Ударные', instr_k:'Клавиши', instr_sx:'Саксофон', instr_tp:'Труба', instr_tb:'Тромбон', instr_vo:'Вокал', instr_bv:'Бэк-вокал', instr_pc:'Перкуссия', piano:'Фортепиано', winds:'Духовые', voice:'Вокал',
...
function setLang(lang){
  ...
  // Update all instrument chip labels
  ['eg','ag','b','dr','k','sx','tp','tb','vo','bv','pc'].forEach(code=>{
    const k='instr_'+code;
    ['chip-'+{'eg':'eguitar','ag':'aguitar','b':'bass','dr':'drums','k':'keys','sx':'sax','tp':'trumpet','tb':'trombone','vo':'vocal','bv':'backing','pc':'percussion'}[code], 'chip-'+{'eg':'eguitar','ag':'aguitar','b':'bass','dr':'drums','k':'keys','sx':'sax','tp':'trumpet','tb':'trombone','vo':'vocal','bv':'backing','pc':'percussion'}[code]+'-m'].forEach(id=>{
      const el=document.getElementById(id);
      if(el){const span=el.querySelector('span');if(span)span.textContent=tr(k);}
    });
  });
